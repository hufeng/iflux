...
module.exports = function(store, reset)  {
  ...
  return {
    ...
    componentDidMount: function() {
      ...
      store.onStoreChange(this.onReplaceStoreData);
    },


    /**
     * 当组件Unmount后，解绑callbacks里的回调
     */
    componentWillUnmount: function() {
      this._isMounted = false;
      store.offStoreChange(this.onReplaceStoreData);
    },
     ...
     * 替换store里的值
     */
    onReplaceStoreData: function(nextState, path) {
      if(this._isMounted) {
